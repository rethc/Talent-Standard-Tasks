  ...
  render() {
    let uploaders = this.props.videos.map((x) => (
      <VideoUpload
        ...
        saveVideoUrl={
          "https://cprofileservices2.azurewebsites.net/profile/profile/updateTalentVideo"
        }
      />
    ));
    uploaders.push(
      <VideoUpload videoName="" updateProfileData={this.updateForComponentId} />
    );

    return <React.Fragment>{uploaders}</React.Fragment>;
  }
}
