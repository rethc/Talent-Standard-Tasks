  ...
  render() {
    ...
    const form =
      formType === "login" ? (
        <LoginForm
          ...
          closeModal={this.props.closeModalWithoutEvent}
        />
      ...
      formType === "login" ? (
        <span className="center aligned">
          ...
          <a
            ...
            onClick={() => this.props.toggleModal(true, "forgotpassword")}
          >
            Reset my password
          </a>
        </span>
    ...
    return (
      <Modal
        ...
        className={
          formType == undefined ? "" : `${formType.toLowerCase()}-modal`
        }
      >
        <Modal.Content scrolling>
          ...
          <div className="field text center form-footer">
            <span className="center aligned">
              ...
              <a
                onClick={() =>
                  this.props.toggleModal(true, alternateLink.toLowerCase())
                }
              >
                {" "}
                {alternateLink}
