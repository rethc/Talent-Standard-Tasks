            ...
            {!this.props.changeName ? (
              <span>
                {this.props.userRole == "talent"
                  ...
                  : this.props.userName}
                <button
                  className="ui basic button user-setting-edit"
                  onClick={() => this.changeState({ changeName: true })}
                >
                  ...
                  <div className="two fields">
                    <div className="field">
                      <input
                        ...
                        value={this.props.userName.split(",")[0]}
                    ...
                    <div className="field">
                      <input
                        ...
                        value={this.props.userName.split(",")[1]}
                        onChange={this.props.handleInputChange}
                      />
                    </div>
                    <button
                      ...
                      onClick={(e) => this.props.save(e, "name")}
                    >
                      Save
                    </button>
                    <button
                      ...
                      onClick={() =>
                        this.changeState({
                          changeName: false,
                          userName: this.props.userNameOriginal,
                        })
                      }
                    >
                      Cancel
            ...
            {!this.props.changePassword ? (
              <div className="ui items">
                <div className="item">
                  <div className="content">
                    <a
                      onClick={() => this.changeState({ changePassword: true })}
                    >
                      Change Password
                    </a>
                  </div>
              ...
              <div className="ui form error">
                ...
                <button
                  className="ui teal button"
                  type="button"
                  onClick={(e) => this.props.save(e, "password")}
                >
                  Save
                </button>
                <button
