...
export default class UserAccountSetting extends React.Component {
  ...
  save(e, field) {
    ...
    if (field == "name") {
      $.ajax({
        url:
          "https://cidentityservices.azurewebsites.net/authentication/authentication/changeUserName?userName=" +
          this.state.userName,
        type: "POST",
        headers: {
    ...
    if (field == "password") {
      ...
      $.ajax({
        url:
          "https://cidentityservices.azurewebsites.net/authentication/authentication/changePassword",
        type: "POST",
    ...
    if (field == "deactivate") {
      $.ajax({
        url:
          "https://cidentityservices.azurewebsites.net/authentication/authentication/deactivateAccount",
        type: "POST",
        headers: {
          Authorization: "Bearer " + cookies,
          "Content-Type": "application/json; charset=utf-8",
        ...
        success: function (res) {
          TalentUtil.notification.show(
            "Success. Your account will be deactivated once you sign out",
            "success"
          );
          this.setState({
            open: false,
        ...
        error: function (res) {
          TalentUtil.notification.show(
            "Error while deactivating your account",
            "error"
          );
        },
      });
  ...
  getUserRole() {
    ...
    $.ajax({
      url:
        "https://cidentityservices.azurewebsites.net/authentication/authentication/getAccountSettingInfo",
      type: "GET",
      headers: {
        Authorization: "Bearer " + cookies,
        "Content-Type": "application/json; charset=utf-8",
                  ...
                  {this.state.activeItem == "account" ? (
                    ...
                    <div className="ui grid">
                      ...
                      <h4 className="ui header">
                        ...
                        <div className="content">Deactivate account</div>
                      </h4>
                      <div className="ui row">
                        <div className="ui ten wide column">
                          <h4 className="ui header">
                            ...
                            <div className="sub header">
                              Once you deactivate your account your account will
                              be locked. Your account will be reactivated
                        ...
                        >
                          ...
                          <Modal.Actions>
                            <button
                              className="ui teal button"
                              onClick={(e) => this.save(e, "deactivate")}
                            >
                              Deactivate
                            </button>
