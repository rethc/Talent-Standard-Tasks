...
export class JobSummaryCard extends React.Component {
  ...
  selectJob(id) {
    ...
    $.ajax({
      url: "https://ctalentservices.azurewebsites.net/listing/listing/closeJob",
      headers: {
      ...
      buttonSwitch = (
        <div className="ui right floated mini buttons">
          ...
          <button
            className="right floated ui mini basic blue button"
            onClick={() => {
              window.location = "/EditJob/" + data.id;
            }}
          >
          ...
          <button
            className="right floated ui mini basic blue button"
            onClick={() => {
              window.location = "/PostJob/" + data.id;
            }}
          >
      ...
      <div className="card manage-job">
        ...
        <div className="extra content">
          ...
          {moment(data.expiryDate) < moment() ? (
            <label className="ui red left floated label">Expired</label>
          ) : null}
        </div>
      </div>
    );
