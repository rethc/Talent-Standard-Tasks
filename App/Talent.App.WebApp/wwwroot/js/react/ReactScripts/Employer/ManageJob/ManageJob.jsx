...
export default class ManageJob extends React.Component {
  ...
  loadData(callback) {
    var link =
      "https://ctalentservices.azurewebsites.net/listing/listing/getSortedEmployerJobs";
    ...
    $.ajax({
      ...
      success: function (res) {
        console.log(res);
        this.setState(
          { loadJobs: res.myJobs, totalPages: Math.ceil(res.totalCount / 6) },
          callback
        );
      }.bind(this),
